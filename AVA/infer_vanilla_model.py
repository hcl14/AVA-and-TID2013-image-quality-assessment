...
model.load_weights(path.join(path.dirname(path.abspath(__file__)),'weights-vanilla-continue3-01-0.79.hdf5'))
...
savemat('wtf_vanilla.mat', {'labels':labels_good1, 'predictions':all_predictions})
'''
