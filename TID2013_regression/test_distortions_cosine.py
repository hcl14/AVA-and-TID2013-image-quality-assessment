...
filenames = [f for f in os.listdir('test_distortions') if f.find('res')!=-1]

undistorted = 'res.jpg'
mean1, features1 = test_inference('test_distortions/'+undistorted)

for filename in filenames:
    mean2, features2 = test_inference('test_distortions/'+filename)
    cos = cosine(features1[0], features2[0])
    print('file:{}, score:{}, cos: {}'.format(filename, mean2, cos))




filenames = [f for f in os.listdir('test_distortions') if f.find('0864')!=-1]

undistorted = '0864_d2.png'
mean1, features1 = test_inference('test_distortions/'+undistorted)
